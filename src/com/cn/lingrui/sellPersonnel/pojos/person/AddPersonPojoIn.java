package com.cn.lingrui.sellPersonnel.pojos.person;
...
public class AddPersonPojoIn {
	...
	private String NBPT_SP_PERSON_IDNUM; // 身份正号码
	...
	private String addPersonType; // 1:加人申请,2:修改申请,3:驳回修改申请
	...
	public String getAddPersonType() {
		return addPersonType;
	}
	public void setAddPersonType(String addPersonType) {
